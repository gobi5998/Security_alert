...
class ApiService {
  ...
  Future<bool> _refreshToken() async {
    try {
      ...
      final response = await _dioAuth.post(
        'https://1931745e04a3.ngrok-free.app/auth/refresh-token',
  ...
  Future<Response> getProfile() async {
    try {
      final response = await _dioAuth.get('https://1931745e04a3.ngrok-free.app/user/me');
      return response;
    } catch (e) {
  ...
  Future<Map<String, dynamic>> login(String username, String password) async {
    try {
      ...
      final response = await _dioAuth.post(ApiConfig.loginEndpoint, data: {
        'username': username,
        'password': password,
      },
      options: Options(
  ...
  Future<Map<String, dynamic>?> getUserProfile() async {
    try {
      ...
      print('response datasssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss$response');
      if (response.statusCode == 200) {
        return response.data;
      }
      throw Exception('Failed to fetch user profile');
