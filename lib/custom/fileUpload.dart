  ...
  Future<void> _pickImages() async {
    ...
    if (selectedImages.length >= 5) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text(
            'Maximum 5 screenshots allowed. Please remove some screenshots',
          ),
  ...
  Future<void> _pickDocuments() async {
    ...
    if (selectedDocuments.length >= 5) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text(
            'Maximum 5 documents allowed. Please remove some documents files',
          ),
          backgroundColor: Colors.red,
          duration: Duration(seconds: 3),
        ),
  ...
  Future<void> _pickVoiceFiles() async {
    ...
    if (selectedVoiceFiles.length >= 5) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text(
            'Maximum 5 voice files allowed. Please remove some voice files',
          ),
          backgroundColor: Colors.red,
          duration: Duration(seconds: 3),
        ),
  ...
  Future<void> _pickVideoFiles() async {
    ...
    if (selectedVideoFiles.length >= 5) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text(
            'Maximum 5 video files allowed. Please remove some video files',
          ),
          backgroundColor: Colors.red,
          duration: Duration(seconds: 3),
        ),
